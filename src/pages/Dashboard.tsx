...
import { LogOut, User, Shield, Car, Mail } from 'lucide-react'
...
const Dashboard = () => {
  ...
  const handleRoleChange = (role: any) => {
    // Since RoleSelector only shows for admin users, we can directly switch roles
    setCurrentRole(role)
    toast.success(`Switched to ${role.role} role`)
  }

  const getRoleIcon = () => {
    // This is a placeholder - we'll get the actual role from Firestore later
