...
const UserDashboard = () => {
  ...
  // Set default tab based on admission status
  useEffect(() => {
    if (student.admissionStatus === 'pending' || student.admissionStatus === 'rejected' || student.admissionStatus === 'none') {
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <button
                  onClick={() => setStudent(prev => ({ ...prev, admissionStatus: 'none' }))}
                  className="bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-colors"
                >
                  Reapply Now
                </button>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-2">Medical Conditions (if any)</label>
                    <textarea
                  ...
                  <div>
                    <label className="text-sm font-medium text-gray-700 mb-2">Special Requirements</label>
                    <textarea
